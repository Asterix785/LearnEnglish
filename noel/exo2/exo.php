<html>
<head>
<title>Learn English : Noël - Exo2</title>
...
<center><br>
	...
	<br><br><br><table width=300 height=10>
		<tr>
			<td>
			<audio controls id="Christmas sleigh" name="drag1" draggable="true" ondragstart="drag(event)">
				<source src="traineau.mp3" type="audio/mpeg"
			</audio>
			</td>
			<td>
			<audio controls id="Father christmas" name="drag2" draggable="true" ondragstart="drag(event)">
				<source src="perenoel.mp3" type="audio/mpeg"
			</audio>
			</td>
			<td>
			<audio controls id="Fireplace" name="drag3" draggable="true" ondragstart="drag(event)">
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
	...
	if ($_POST["div1"] == "Father christmas" && $_POST["div2"] == "Fireplace" && $_POST["div3"] == "Christmas sleigh")
	{
